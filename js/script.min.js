    ...
    !function(e, t) {
        ...
        var t = "function" == typeof e
          ...
          , m = function(e, t, n) {
            var a, i;
            for (a in t)
                (i = void 0 !== e[a]) && "object" == typeof t[a] && null !== t[a] && void 0 === t[a].nodeName ? h(t[a]) ? n && (e[a] = new Date(t[a].getTime())) : l(t[a]) ? n && (e[a] = t[a].slice(0)) : e[a] = m({}, t[a], n) : !n && i || (e[a] = t[a]);
            return e
        }
          , p = function(e, t, n) {
            var i;
          ...
          , M = function(e, t, n, a, i, s) {
            var o, r, h, d, u, c = e._o, f = n === c.minYear, g = n === c.maxYear, m = '<div id="' + s + '" class="pika-title" role="heading" aria-live="assertive">', p = !0, y = !0;
            for (h = [],
            o = 0; o < 12; o++)
            ...
            for (d = '<div class="pika-label">' + c.i18n.months[a] + '<select class="pika-select pika-select-month" tabindex="-1">' + h.join("") + "</select></div>",
            l(c.yearRange) ? (o = c.yearRange[0],
            r = c.yearRange[1] + 1) : (o = n - c.yearRange,
            r = 1 + n + c.yearRange),
            h = []; o < r && o <= c.maxYear; o++)
                o >= c.minYear && h.push('<option value="' + o + '"' + (o === n ? ' selected="selected"' : "") + ">" + o + "</option>");
            return u = '<div class="pika-label">' + n + c.yearSuffix + '<select class="pika-select pika-select-year" tabindex="-1">' + h.join("") + "</select></div>",
          ...
          , k = function(e, t, n) {
            return '<table cellpadding="0" cellspacing="0" class="pika-table" role="grid" aria-labelledby="' + n + '">' + function(e) {
                ...
                t = 0; t < 7; t++)
                    n.push('<th scope="col"><abbr title="' + v(e, t) + '">' + v(e, t, !0) + "</abbr></th>");
          ...
          , x = function(o) {
            ...
            l._onMouseDown = function(e) {
                if (l._v) {
                    ...
                    if (t)
                        if (r(t, "is-disabled") || (!r(t, "pika-button") || r(t, "is-empty") || r(t.parentNode, "is-disabled") ? r(t, "pika-prev") ? l.prevMonth() : r(t, "pika-next") && l.nextMonth() : (l.setDate(new Date(t.getAttribute("data-pika-year"),t.getAttribute("data-pika-month"),t.getAttribute("data-pika-day"))),
                        d.bound && i((function() {
                            l.hide(),
            ...
            l._onInputChange = function(n) {
                var a;
                n.firedBy !== l && (a = d.parse ? d.parse(d.field.value, d.format) : t ? (a = e(d.field.value, d.format, d.formatStrict)) && a.isValid() ? a.toDate() : null : new Date(Date.parse(d.field.value)),
                h(a) && l.setDate(a),
                l._v || l.show())
            }
            ,
            ...
            l._onClick = function(e) {
                var t = (e = e || window.event).target || e.srcElement
                  , a = t;
                if (t) {
                    !n && r(t, "pika-select") && (t.onchange || (t.setAttribute("onchange", "return;"),
                    s(t, "change", l._onChange)));
                    do {
                        if (r(a, "pika-single") || a === d.trigger)
                            return
            ...
            l.el.className = "pika-single" + (d.isRTL ? " is-rtl" : "") + (d.theme ? " " + d.theme : ""),
            s(l.el, "mousedown", l._onMouseDown, !0),
            s(l.el, "touchend", l._onMouseDown, !0),
            s(l.el, "change", l._onChange),
            s(a, "keydown", l._onKeyChange),
            d.field && (d.container ? d.container.appendChild(l.el) : d.bound ? a.body.appendChild(l.el) : d.field.parentNode.insertBefore(l.el, d.field.nextSibling),
            ...
            d.setDefaultDate = !0));
            var u = d.defaultDate;
            h(u) ? d.setDefaultDate ? l.setDate(u, !0) : l.gotoDate(u) : l.gotoDate(new Date),
            d.bound ? (this.hide(),
            l.el.className += " is-bound",
            s(d.trigger, "click", l._onInputClick),
            s(d.trigger, "focus", l._onInputFocus),
            s(d.trigger, "blur", l._onInputBlur)) : this.show()
        };
        return x.prototype = {
            config: function(e) {
            ...
            toString: function(n) {
                ...
                h(this._d) ? this._o.toString ? this._o.toString(this._d, n) : t ? e(this._d).format(n) : this._d.toDateString() : ""
            },
            getMoment: function() {
            ...
            setMinDate: function(e) {
                ...
                this._o.minMonth = e.getMonth()) : (this._o.minDate = D.minDate,
            ...
            setMaxDate: function(e) {
                ...
                this._o.maxMonth = e.getMonth()) : (this._o.maxDate = D.maxDate,
            ...
            draw: function(e) {
                if (this._v || e) {
                    var t, n = this._o, a = n.minYear, s = n.maxYear, o = n.minMonth, r = n.maxMonth, l = "";
                    this._y <= a && (this._y = a,
                    ...
                    for (var h = 0; h < n.numberOfMonths; h++)
                        l += '<div class="pika-lendar">' + M(this, h, this.calendars[h].year, this.calendars[h].month, this.calendars[0].year, t) + this.render(this.calendars[h].year, this.calendars[h].month, t) + "</div>";
                    this.el.innerHTML = l,
            ...
            adjustPosition: function() {
                ...
                if (!this._o.container) {
                    ...
                    "function" == typeof e.getBoundingClientRect)
                        ...
                        for (l = t.offsetLeft,
                        h = t.offsetTop + t.offsetHeight; t = t.offsetParent; )
                            l += t.offsetLeft,
                            h += t.offsetTop;
                    (this._o.reposition && l + n > s || this._o.position.indexOf("right") > -1 && l - n + e.offsetWidth > 0) && (l = l - n + e.offsetWidth),
                    (this._o.reposition && h + i > o + r || this._o.position.indexOf("top") > -1 && h - i - e.offsetHeight > 0) && (h = h - i - e.offsetHeight),
            ...
            render: function(e, t, n) {
                ...
                for (var u = 0 === t ? 11 : t - 1, m = 11 === t ? 0 : t + 1, p = 0 === t ? e - 1 : e, y = 11 === t ? e + 1 : e, D = c(p, u), v = s + o, M = v; M > 7; )
                    M -= 7;
                v += 7 - M;
                for (var x = !1, R = 0, N = 0; R < v; R++) {
                    var S = new Date(e,t,R - o + 1)
                      ...
                      , F = a.startRange && a.endRange && a.startRange < S && S < a.endRange;
                    T && (R < o ? (Y = D + Y,
                    O = u,
                    j = p) : (Y -= s,
                    O = m,
                    ...
                    var P = {
                        ...
                        isSelected: C,
                        isToday: E,
                        isDisabled: a.minDate && S < a.minDate || a.maxDate && S > a.maxDate || a.disableWeekends && d(S) || a.disableDayFn && a.disableDayFn(S),
                        isEmpty: T,
                        isStartRange: A,
                        isEndRange: W,
                        isInRange: F,
                    ...
                    l.push(_(P)),
                    7 == ++N && (a.showWeekNumber && l.unshift(b(R - o, t, e)),
...
/*
     FILE ARCHIVED ON 17:04:53 Jun 09, 2023 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 06:49:57 May 09, 2025.
...
playback timings (ms):
  ...
  esindex: 0.012
  cdx.remote: 6.276
  LoadShardBlock: 236.984 (3)
  PetaboxLoader3.resolve: 330.896 (2)
  PetaboxLoader3.datanode: 312.177 (4)
  load_resource: 439.708
*/
